...
import FormComponent from "@/app/components/page-ui/profile-form";
        ...
        <div className="md:flex w-[70vw] mx-auto mt-20">
            <ul className="flex-column space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
                <li>
                    ...
                    >
                        <svg className={`w-4 h-4 me-2 ${activeTab === 'profile' ? 'text-black' : 'text-gray-500 dark:text-gray-400'}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path
                ...
                <li>
                    ...
                    >
                        <svg className={`w-4 h-4 me-2 ${activeTab === 'dashboard' ? 'text-black' : 'text-gray-500 dark:text-gray-400'}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                            <path
                ...
                <li>
                    ...
                    >
                        <svg className={`w-4 h-4 me-2 ${activeTab === 'settings' ? 'text-black' : 'text-gray-500 dark:text-gray-400'}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path
                ...
                <li>
                    ...
                    >
                        <svg className={`w-4 h-4 me-2 ${activeTab === 'contact' ? 'text-black' : 'text-gray-500 dark:text-gray-400'}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M7.824 5.937a1 1 0 0 0 .726-.312 2.042 2.042 0 0 1 2.835-.065 1 1 0 0 0 1.388-1.441 3.994 3.994 0 0 0-5.674.128 1 1 0 0 0 .725 1.69Zm10.111 8.227-3.898-2.999a3.953 3.953 0 0 0-3.949-.433l-1.546.75a2.01 2.01 0 0 1-2.25-.354L3.413 9.573a2 2 0 0 1-.353-2.25l.75-1.545a3.955 3.955 0 0 0-.433-3.949L1.43 1.937a2.01 2.01 0 0 0-3.08.482c-2.081 3.111-1.261 7.26 2.682 11.204 2.549 2.548 5.384 4.097 7.846 4.693.49.123.994.184 1.5.184a9.24 9.24 0 0 0 5.854-2.167 2.01 2.01 0 0 0 .483-3.081Z"/>
                        </svg>
                        Contact
                    </a>
                </li>
