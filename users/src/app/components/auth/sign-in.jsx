    ...
    return (
        <div className="flex flex-wrap h-screen">
            ...
            <div className="pointer-events-none relative hidden h-screen select-none bg-black md:block md:w-2/3">
                ...
                <img className="absolute top-0 h-full w-full object-cover object-center opacity-40 -z-1" src="https://res.cloudinary.com/ddwet1dzj/image/upload/v1720541343/hero-1_raxkds.jpg" alt="Background" />
            </div>
        </div>
    );
};
